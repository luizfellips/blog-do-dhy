        ...
        <div class="p-10 rounded shadow-sm border-2 border-opacity-35 border-blue-700 max-w-lg w-2/3">
            ...
            <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-col mb-4">
                        ...
                        <select id="author" name="author_id" class="mt-2 px-4 py-2 shadow rounded">
                            ...
                            @foreach ($authors as $author)
                                <option value="{{ $author->id }}" {{ $noticia->author->id == $author->id ? 'selected' : '' }}>{{ $author->name }}</option>
                            @endforeach
                        </select>
                ...
                <div class="flex flex-col items-center mb-4">
                    ...
                    <textarea name="corpo"  id="corpo"  class="mt-2 px-4 py-2 shadow rounded">{{$noticia->corpo}}</textarea>
                    <div class="info">
                ...
                <div class="flex flex-col mb-4">
                    ...
                    <input type="text" name="legenda_imagem" value="{{$noticia->legenda_imagem}}" class="mt-2 px-4 py-2 shadow rounded" />
                </div>
                ...
                <div class="tags border-y-2 p-3">
                    ...
                    <div class="flex items-center mt-3">
                        ...
                        {{ in_array($tag->id, $noticia->tags->pluck('id')->toArray()) ? 'checked' : '' }}>
                ...
                <div class="mt-6 flex gap-6">
                    <button type="submit"
                        class="rounded-full bg-blue-500 py-4 px-10 font-bold container transition text-white shadow hover:bg-blue-600">Atualizar</button>
                </div>
            </form>
        </div>
    </div>
